  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="nav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item"><a class="nav-link active" href="index.php">📦 สินค้า</a></li>
...
<main class="container my-5">
  <div class="card">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h2 class="mb-0">รายการสินค้า</h2>
      <a href="create.php" class="btn btn-success"><span class="me-1">➕</span>เพิ่มสินค้า</a>
    </div>
      ...
      <table class="table table-bordered table-hover align-middle bg-white">
        ...
        while ($row = $result->fetch_assoc()) {
          echo "<tr>
                  ...
                  <td>
                      <a href='edit.php?id={$row['product_id']}' class='btn btn-sm btn-warning me-1'>✏️</a>
                      <a href='delete.php?id={$row['product_id']}' onclick='return confirm(\"ลบสินค้านี้ใช่ไหม?\")' class='btn btn-sm btn-danger'>🗑️</a>
                  </td>
              </tr>";
        }
        ?>
