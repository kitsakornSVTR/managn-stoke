...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->bind_param("si", $_POST['category_name'], $id);
    $stmt->execute();
...
<head>
    ...
    <title>แก้ไขหมวดหมู่ - PHP CRUD</title>
...
<main class="container my-5">
  <div class="card">
    <h2 class="mb-4">แก้ไขหมวดหมู่</h2>
    <form method="POST">
      <div class="mb-3">
        <label>ชื่อหมวดหมู่</label>
        <input name="category_name" class="form-control" value="<?= $category['category_name'] ?>" required>
      </div>
