...
<main class="container my-5">
  <div class="card">
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <a href="create.php" class="btn btn-success"><span class="me-1">➕</span>เพิ่มหมวดหมู่</a>
    </div>
      ...
      <table class="table table-bordered table-hover align-middle bg-white">
        ...
        while ($row = $result->fetch_assoc()) {
          echo "<tr>
                  ...
                  <td>
                      <a href='edit.php?id={$row['category_id']}' class='btn btn-sm btn-warning me-1'>✏️</a>
                      <a href='delete.php?id={$row['category_id']}' onclick='return confirm(\"ลบใช่ไหม?\")' class='btn btn-sm btn-danger'>🗑️</a>
                  </td>
              </tr>";
        }
        ?>
